...
#pragma config(Motor,  motorB,          encoderLeft,   tmotorNXT, PIDControl, reversed, encoder)
#pragma config(Motor,  motorC,          encoderRight,  tmotorNXT, PIDControl, reversed, encoder)
...
task main() {
	...
	servo[arm] = ARM_UP - 10;
	vMoveForward(48, DRIVE_SPEED);
	vReleaseRing();
	vMoveBackward(40, DRIVE_SPEED);
