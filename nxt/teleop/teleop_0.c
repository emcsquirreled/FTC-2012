...
task Debug() {
	while(1) {
		eraseDisplay();
		nxtDisplayCenteredTextLine(1, "%d", joystick.joy1_y1);
		nxtDisplayCenteredTextLine(2, "%d", oLeftMotor.iPower);
		nxtDisplayCenteredTextLine(3, "%d", joystick.joy1_y2);
		nxtDisplayCenteredTextLine(4, "%d", oRightMotor.iPower);
		// nxtDisplayCenteredTextLine(3, "%d", oArm.iPosition);
		wait10Msec(1);
	}
}
